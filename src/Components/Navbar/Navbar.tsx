...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="bg-white w-full fixed z-100 top-0 start-0 border-b border-gray-200 dark:border-gray-300 mb-1 overflow-hidden ">
            <motion.div
                initial={{ scale: 0 }}
            ...
            <div className='w-full flex justify-center mt-5 mb-2'>
                <motion.ul
                    ...
                    className=' flex flex-wrap justify-center items-center gap-10 text-2xl '>
                    {
                        links.map((link) => (
